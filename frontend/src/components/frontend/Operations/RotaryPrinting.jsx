...
import Banner from '../../../assets/images/Operations/rotary-printing/banner-1.png'
import Banner2 from '../../../assets/images/Operations/rotary-printing/banner-2.png'
const RotaryPrinting = () => {
  return (
    <>
    <Header/>
    <Hero heading={"Operations"} subheading={" / Rotary Printing"}/>
    <section className='container py-5 section-product'>
                <div className="row py-5">
                    <div className="col-md-8">
                        <h2>Rotary Printing</h2>
                        ...
                        <div className="card shadow border-0 rounded-0 mt-4">
                            <img src={Banner2} alt="" width='100%' className='rounded' />
