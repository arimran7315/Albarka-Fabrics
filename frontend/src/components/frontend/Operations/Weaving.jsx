...
import Banner from '../../../assets/images/Operations/weaving/banner-1.png';
import Banner2 from '../../../assets/images/Operations/weaving/banner-2.png';
const Weaving = () => {
    return (
        <>
            <Header />
            <Hero heading={"Operations"} subheading={" / Weaving"} />
