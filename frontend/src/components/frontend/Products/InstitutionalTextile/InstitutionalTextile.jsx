...
import Banner from '../../../../assets/images/products/InstitutionalTextile/banner-1.png'
import { Link } from 'react-router-dom'
import { apiUrl, fileUrl } from '../../../common/http'
const InstitutionalTextile = () => {
  const [products, setProducts] = useState('');
  const fetchProcess = async () => {
    const res = await fetch(apiUrl + 'product/Institutional Textile/none', {
      method: 'GET',
      headers: {
  ...
  return (
    <>
      <Header />
      <main>
        <Hero heading={'Product'} subheading={'/ Institutional Textile'} />
        <section className="section-product container py-5">
          <div className="row py-5">
            <div className="col-md-8">
              <h2> Institutional Textile </h2>
...
export default InstitutionalTextile